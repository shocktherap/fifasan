...
<td><h4>Nomer Telepon : <?php print_r($user->phone_number);?></h4></td>
  <table class="table">
    <tr>
    ...
    <tr>
      <td>
        ...
        <div class="controls">
          <input type="password" id="inputname" name="old_password" value="<?php echo set_value('old_password');?>" placeholder="Password Lama"></input>
    ...
    <tr>
      ...
      <div class="control-group <?=$message1;?>">
        ...
        <div class="controls">
          <input type="password" id="inputnewpassword" name="new_password" value="<?php echo set_value('new_password');?>" placeholder="Password Baru"></input>
    ...
    <tr>
      ...
      <div class="control-group <?=$message2;?>">
        ...
        <div class="controls">
          <input type="password" id="inputconfirmasi_password" name="confirm_password" value="<?php echo set_value('confirm_password');?>" placeholder="Confirmasi Password"></input>
